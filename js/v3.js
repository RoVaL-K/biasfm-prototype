...
(function (root) {
  ...
  function renderSong(container, id, release = false) {
    ...
    }).catch(() => { if (itemStats) itemStats.innerHTML = '<span>Öffentliche Sammlungszahlen werden nach Verfügbarkeit angezeigt.</span>'; });
