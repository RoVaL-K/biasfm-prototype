...
(function (root) {
  ...
  function setupLocalV2Store() {
    ...
    root.biasStore.privacySettings = {
      profile: 'public', stats: 'private', activity: 'private', follows: 'public', favorites: 'public', showNowPlaying: true,
  ...
  function renderProfileEdit(container) {
    ...
    if (nowPlayingToggle) nowPlayingToggle.checked = setPrivacy.showNowPlaying !== false;
  ...
  function patchProfileView() {
    ...
    root.biasProfileView.saveProfile = function () {
      ...
      try {
        ...
        privacyValues.showNowPlaying = document.getElementById('privacy-now-playing')?.checked !== false;
