  ...
  class StatsView {
    ...
    render(container) {
      ...
      container.innerHTML = `<div class="view-stats">
        ...
        </form><details class="section-note"><summary>Warum kein Spotify-Pflichtlogin?</summary><p>Eine Spotify-Anmeldung liefert nicht automatisch deinen vollständigen Hörverlauf. Für die Statistik nutzen wir öffentliche Scrobbles von Last.fm oder ListenBrainz. Die Spotify-Verbindung in deinen Einstellungen ist für Profil und Playlists gedacht.</p></details></div>
